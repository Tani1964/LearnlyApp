...
const DashboardTop = () => {
  return (
    <div className="h-[50%] flex gap-4 ">
        <div className="w-[50%] rounded-2xl bg-white shadow-lg shadow-orange-400 p-4 flex flex-col justify-between">
        ...
        <div className="w-[50%] rounded-2xl bg-white shadow-lg shadow-orange-400 p-4">
